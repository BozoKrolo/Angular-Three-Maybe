...
export declare class KTX2LoaderService extends ThCallbackLoaderService<KTX2Loader> {
...
export declare class ThKTX2LoaderPipe extends ThCallbackLoaderBasePipe<KTX2Loader> implements PipeTransform {
...
export declare class ThKTX2LoaderDirective extends ThCallbackLoaderBaseDirective<KTX2Loader> {
