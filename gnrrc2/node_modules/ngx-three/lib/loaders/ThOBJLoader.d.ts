...
export declare class OBJLoaderService extends ThAsyncLoaderService<OBJLoader> {
...
export declare class ThObjLoaderPipe extends ThAsyncLoaderBasePipe<OBJLoader> implements PipeTransform {
...
export declare class ThObjLoaderDirective extends ThAsyncLoaderBaseDirective<OBJLoader> {
    protected host: ThObject3D;
    protected zone: NgZone;
    protected service: OBJLoaderService;
    constructor(host: ThObject3D, zone: NgZone, service: OBJLoaderService);
    protected getRefFromResponse(response: Group): Group;
