...
export declare class TextureLoaderService extends ThCallbackLoaderService<TextureLoader> {
...
export declare class ThTextureLoaderPipe extends ThCallbackLoaderBasePipe<TextureLoader> implements PipeTransform {
...
export declare class ThTextureLoaderDirective extends ThCallbackLoaderBaseDirective<TextureLoader> {
