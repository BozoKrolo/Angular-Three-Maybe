...
export declare class PLYLoaderService extends ThAsyncLoaderService<PLYLoader> {
...
export declare class ThPLYLoaderPipe extends ThAsyncLoaderBasePipe<PLYLoader> implements PipeTransform {
...
export declare class ThPLYLoaderDirective extends ThAsyncLoaderBaseDirective<PLYLoader> {
    protected host: ThBufferGeometry;
    protected zone: NgZone;
    protected service: PLYLoaderService;
    constructor(host: ThBufferGeometry, zone: NgZone, service: PLYLoaderService);
    protected getRefFromResponse(response: BufferGeometry): BufferGeometry;
