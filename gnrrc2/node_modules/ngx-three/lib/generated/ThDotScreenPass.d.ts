...
export declare class ThDotScreenPass<T extends DotScreenPass = DotScreenPass, TARGS = [center?: Vector2, angle?: number, scale?: number]> extends ThPass<T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThDotScreenPass<any, any>, "th-dotScreenPass", never, { "uniforms": "uniforms"; "material": "material"; "fsQuad": "fsQuad"; }, {}, never, ["*"], false, never>;
}
