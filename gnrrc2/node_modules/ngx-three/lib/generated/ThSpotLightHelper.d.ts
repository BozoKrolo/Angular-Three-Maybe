...
export declare class ThSpotLightHelper<T extends SpotLightHelper = SpotLightHelper, TARGS = [light: Light, color?: ColorRepresentation]> extends ThObject3D<Event, T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThSpotLightHelper<any, any>, "th-spotLightHelper", never, { "cone": "cone"; "light": "light"; "matrix": "matrix"; "color": "color"; "matrixAutoUpdate": "matrixAutoUpdate"; }, {}, never, ["*"], false, never>;
}
