...
export declare class ThPass<T extends Pass = Pass, TARGS = []> extends ThPassBase<T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThPass<any, any>, "th-pass", never, { "isPass": "isPass"; "enabled": "enabled"; "needsSwap": "needsSwap"; "clear": "clear"; "renderToScreen": "renderToScreen"; }, {}, never, ["*"], false, never>;
}
