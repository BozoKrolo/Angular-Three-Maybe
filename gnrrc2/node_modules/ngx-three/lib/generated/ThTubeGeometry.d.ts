...
export declare class ThTubeGeometry<T extends TubeGeometry = TubeGeometry, TARGS = [path?: Curve<Vector3>, tubularSegments?: number, radius?: number, radialSegments?: number, closed?: boolean]> extends ThBufferGeometry<T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThTubeGeometry<any, any>, "th-tubeGeometry", never, { "tangents": "tangents"; "normals": "normals"; "binormals": "binormals"; }, {}, never, ["*"], false, never>;
}
