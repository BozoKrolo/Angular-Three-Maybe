...
export declare class ThSavePass<T extends SavePass = SavePass, TARGS = WebGLRenderTarget> extends ThPass<T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThSavePass<any, any>, "th-savePass", never, { "textureID": "textureID"; "renderTarget": "renderTarget"; "uniforms": "uniforms"; "material": "material"; "fsQuad": "fsQuad"; }, {}, never, ["*"], false, never>;
}
