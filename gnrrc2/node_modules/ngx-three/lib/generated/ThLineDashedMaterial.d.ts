...
export declare class ThLineDashedMaterial<T extends LineDashedMaterial = LineDashedMaterial, TARGS = LineDashedMaterialParameters> extends ThLineBasicMaterial<T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThLineDashedMaterial<any, any>, "th-lineDashedMaterial", never, { "type": "type"; "scale": "scale"; "dashSize": "dashSize"; "gapSize": "gapSize"; }, {}, never, ["*"], false, never>;
}
