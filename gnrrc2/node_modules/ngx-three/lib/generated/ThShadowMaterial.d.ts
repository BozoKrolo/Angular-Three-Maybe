...
export declare class ThShadowMaterial<T extends ShadowMaterial = ShadowMaterial, TARGS = ShadowMaterialParameters> extends ThMaterial<T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThShadowMaterial<any, any>, "th-shadowMaterial", never, { "type": "type"; "color": "color"; "transparent": "transparent"; "fog": "fog"; }, {}, never, ["*"], false, never>;
}
