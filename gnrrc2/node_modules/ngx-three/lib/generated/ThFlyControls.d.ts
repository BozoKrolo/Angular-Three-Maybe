...
export declare class ThFlyControls<T extends FlyControls = FlyControls, TARGS = [object: Camera, domElement?: HTMLElement]> extends ThControlBase<T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThFlyControls<any, any>, "th-flyControls", never, { "object": "object"; "domElement": "domElement"; "movementSpeed": "movementSpeed"; "rollSpeed": "rollSpeed"; "dragToLook": "dragToLook"; "autoForward": "autoForward"; }, {}, never, ["*"], false, never>;
}
