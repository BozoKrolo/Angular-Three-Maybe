...
export declare class ThRoundedBoxGeometry<T extends RoundedBoxGeometry = RoundedBoxGeometry, TARGS = [width?: number, height?: number, depth?: number, segments?: number, radius?: number]> extends ThBoxGeometry<T, TARGS> {
