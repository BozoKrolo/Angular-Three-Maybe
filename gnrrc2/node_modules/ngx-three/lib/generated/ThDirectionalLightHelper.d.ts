...
export declare class ThDirectionalLightHelper<T extends DirectionalLightHelper = DirectionalLightHelper, TARGS = [light: DirectionalLight, size?: number, color?: ColorRepresentation]> extends ThObject3D<Event, T, TARGS> {
    ...
    static ɵcmp: i0.ɵɵComponentDeclaration<ThDirectionalLightHelper<any, any>, "th-directionalLightHelper", never, { "lightPlane": "lightPlane"; "light": "light"; "matrix": "matrix"; "matrixAutoUpdate": "matrixAutoUpdate"; "color": "color"; "targetLine": "targetLine"; }, {}, never, ["*"], false, never>;
}
