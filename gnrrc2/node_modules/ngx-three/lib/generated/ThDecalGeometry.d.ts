...
export declare class ThDecalGeometry<T extends DecalGeometry = DecalGeometry, TARGS = [mesh: Mesh, position: Vector3, orientation: Euler, size: Vector3]> extends ThBufferGeometry<T, TARGS> {
